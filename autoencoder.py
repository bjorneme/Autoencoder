...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.Conv2d(1, 16, kernel_size=3, stride=2, padding=1),  # Output size: (batch_size, 16, 14, 14)
            nn.ReLU(),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(16, 1, kernel_size=3, stride=2, padding=1, output_padding=1),  # Output size: (batch_size, 1, 28, 28)
